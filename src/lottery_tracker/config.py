...
class Config:
    def __init__(self, raw: dict):
        ...
        # Pack (book) sizes — how many tickets are in a full pack, used by the
        # scan tracker. Optional; sizes are also learned from real scans.
        #   pack_sizes:
        #     by_price: {1: 300, 5: 60, ...}   # tickets per pack, by ticket price
        #     by_game:  {"1750": 20}           # override one game exactly
        #     use_builtin_fallback: true       # use built-in guesses when unset
